...
@brief 
    This module implements the MEMORY DUMP 64/byte main program
@todo
...
#define TYPEMASK (0xFFFFFFFFFFFFFFFF)

#define FORMATW_ADDR "%016llX: %016llX%s"
#define FORMATWOADDR "%s%016llX%s"
