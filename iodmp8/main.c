...
@brief 
    This module implements the I/O DUMP 8/byte main program
@todo
...
int main(int argc, char** argv) {
    ...
    for (i = 0; i < (end - start) / TYPESIZE; i++)
        printf((i % (16 / TYPESIZE) == 0 ? FORMATW_ADDR : FORMATWOADDR), (i % (16 / TYPESIZE) == 0 ? (void*)(start + i * TYPESIZE) : ""), TYPEMASK & inp(start + i * TYPESIZE), ((i + 1) % (16 / TYPESIZE)) ? (((i + 1) % (8 / TYPESIZE)) ? " " : " - ") : "\n");
